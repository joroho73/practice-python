...
There are forty exercises to complete. 
...
| [ex_09.py](ex_09.py) | **Guessing Game One** | Generate a random number between 1 and 9 (including 1 and 9). Ask the user to guess the number, then tell them whether they guessed too low, too high, or exactly right. | 20/10/25 |
